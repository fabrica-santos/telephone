...
func open_application(app_name: String = ""):
	create_window(app_database[app_name]["scene_file"], app_database[app_name]["icon"], app_database[app_name]["name"], Vector2(250.0, 250.0), app_database[app_name]["drag"], app_database[app_name]["resize_w"], app_database[app_name]["resize_h"], app_database[app_name]["main_focus"], app_database[app_name]["can_min"], app_database[app_name]["can_wind"], app_database[app_name]["can_close"], app_database[app_name]["task_bar"], app_database[app_name]["wind_size"], app_database[app_name]["wind_min"], app_database[app_name]["wind_max"], app_database[app_name]["destroy"])
...
func create_window(window_content: String, icon: String = "", title: String = "", position: Vector2 = Vector2(250.0, 250.0), drag: bool = true, resize_w: bool = true, resize_h: bool = true, main_focus: bool = false, can_min: bool = true, can_wind: bool = true, can_close: bool = true, task_bar: bool = true, size: Vector2 = Vector2(100.0, 100.0), min_size: Vector2 = Vector2(100.0, 100.0), max_size: Vector2 = Vector2(800.0, 600.0), destroy: bool = true):
	...
	window_instance.window_icon = load(small_icon_dir+icon)
